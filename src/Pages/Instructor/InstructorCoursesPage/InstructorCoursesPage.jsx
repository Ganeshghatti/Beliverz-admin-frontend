...
export default function InstructorCoursesPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        if (instructor.isInstructor && courseId) {
          setLoading(true);
          console.log(courseId);
          const response = await axios.get(
            `https://beliverz-admin.vercel.app/courses/${courseId}`,
            {
              headers: {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        if (courseId && instructor.token) {
          setinstructorLoading(true);
          console.log(courseId);
          const response = await axios.get(
            `https://beliverz-admin.vercel.app/courses/${courseId}/instructors`,
            {
              headers: {
                Authorization: `Bearer ${instructor.token}`,
              },
  ...
  const createNewCoursef = async () => {
    try {
      ...
      const response = await axios.post(
        `https://beliverz-admin.vercel.app/courses/${courseId}/newChapter`,
  ...
  const handlechaptervideoupload = async (e, chapterId) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://beliverz-admin.vercel.app/courses/${courseId}/upload-content`,
        {
          content: {
    ...
    try {
      if (isConfirmed && chapterId && courseId) {
        ...
        const response = await axios.delete(
          `https://beliverz-admin.vercel.app/courses/${courseId}/delete-chapter/${chapterId}`,
          {
            headers: {
              Authorization: `Bearer ${instructor.token}`,
            },
  ...
  const handledeletecontent = async (chapterId, contentId) => {
    ...
    try {
      if (isConfirmed && chapterId && courseId && contentId) {
        setLoading(true);
        const response = await axios.delete(
          `https://beliverz-admin.vercel.app/courses/${courseId}/delete-content/${chapterId}/${contentId}`,
          {
            headers: {
              Authorization: `Bearer ${instructor.token}`,
            },
  ...
  return (
    <div className="InstructorCoursesPage flex flex-col relative">
